use crate::{
  ...
  post::PostResponse,
  pipayment::{CaptchaItem, TokenItem, PiTokenItem},
  pipayment::PiUserDto,
  websocket::{serialize_websocket_message, OperationType},
};
...
impl ChatServer {
    ...
    OP: OperationType + ToString,
  {
    ...
    self
      .send_community_room_message(user_operation, &post_sent, CommunityId(Uuid::parse_str("00000000-0000-0000-0000-000000000000").unwrap()), websocket_id)
      .await?;
    self
